...
def main(args):
    ...
    sensors_to_log = {
        ...
        'tilt': tilt.TiltHydrometerSensor(args.tilt_color),
...
if __name__ == "__main__":
    ...
    parser.add_argument("--log_file", default='./brew-logs/log_%d.tsv' % time.time(), type=str,
                        help="CSV filename for log output.")
    parser.add_argument("--backup_log_file", default='./brew-logs/gsheet_bkp.tsv', type=str,
