...
# expected_header = ['clock_time', 'ALS_lux', 'UV_uv', 'UV_uv_index', 'TEMP_temperature',
...
expected_header = ['clock_time', 'ALS_lux', 'UV_uv', 'UV_uv_index', 'TEMP_F_temperature',
                   'MPTT_in_load_current', 'MPTT_in_load_voltage', 'MPTT_in_shunt_voltage', 
                   'MPTT_out_load_current', 'MPTT_out_load_voltage', 'MPTT_out_shunt_voltage']
...
def main(args):
    ...
    sensors_to_log = {
        ...
        'MPTT_in': sensors.HighSideCurrentINA219(address=LOAD_I2C_ADDR),
        'MPTT_out': sensors.HighSideCurrentINA219(address=CHARGE_I2C_ADDR),
    }
...
if __name__ == "__main__":
    ...
    parser.add_argument("--gsheet_secret", default='./auth/solar-secret.json', type=str,
    ...
    parser.add_argument("--log_file", default='./solar-logs/log_%d.tsv' % time.time(), type=str,
                        help="CSV filename for log output.")
    parser.add_argument("--backup_log_file", default='./solar-logs/gsheet_bkp.tsv', type=str,
